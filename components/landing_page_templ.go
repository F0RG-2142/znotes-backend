...
func login() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<div id=\"login\" class=\"modal-overlay\"><div class=\"modal-content\"><a href=\"#page\" class=\"close-btn\" aria-label=\"Close login form\">&times;</a><h2>Login to ZNotes</h2><form><div class=\"form-group\"><label for=\"loginEmail\">Email Address</label> <input type=\"email\" id=\"loginEmail\" name=\"loginEmail\" required></div><div class=\"form-group\"><label for=\"loginPassword\">Password</label> <input type=\"password\" id=\"loginPassword\" name=\"loginPassword\" required></div><button type=\"submit\" class=\"form-btn\">Login</button></form></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func register() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<div id=\"register\" class=\"modal-overlay\"><div class=\"modal-content\"><a href=\"#page\" class=\"close-btn\" aria-label=\"Close registration form\">&times;</a><h2>Create ZNotes Account</h2><form><div class=\"form-group\"><label for=\"registerEmail\">Email Address</label> <input type=\"email\" id=\"registerEmail\" name=\"registerEmail\" required></div><div class=\"form-group\"><label for=\"registerPassword\">Password</label> <input type=\"password\" id=\"registerPassword\" name=\"registerPassword\" required></div><button type=\"submit\" class=\"form-btn\">Register</button></form></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
