...
RETURNING id, created_at, updated_at, email, hashed_password, has_notes_premium
`
...
SELECT id, created_at, updated_at, email, hashed_password, has_notes_premium FROM users WHERE email = $1
`
